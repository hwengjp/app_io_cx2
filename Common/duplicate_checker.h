...
void MWPFX(DUPCHK_vInit)(tsDupChk_Context *p);
bool_t MWPFX(DUPCHK_bFind)(tsDupChk_Context *p, uint32 u32Addr, uint32 *pu32Key);
void MWPFX(DUPCHK_vAdd)(tsDupChk_Context *p, uint32 u32Addr, uint32 u32Key);
