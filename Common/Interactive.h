...
#define IS_APPCONF_OPT_LOW_LATENCY_INPUT() (sAppStg.u32Opt & E_APPCONF_OPT_LOW_LATENCY_INPUT) //!< E_APPCONF_OPT_LOW_LATENCY_INPUT 判定 @ingroup FLASH

#define E_APPCONF_OPT_LOW_LATENCY_INPUT_SLEEP_TX_BY_INT 0x0002UL //!< スリープを H>L 検出した場合に、割り込み要因のポートのみ送信する @ingroup FLASH
#define IS_APPCONF_OPT_LOW_LATENCY_INPUT_SLEEP_TX_BY_INT() (sAppStg.u32Opt & E_APPCONF_OPT_LOW_LATENCY_INPUT_SLEEP_TX_BY_INT) //!< E_APPCONF_OPT_LOW_LATENCY_INPUT_SLEEP_TX_BY_INT 判定 @ingroup FLASH

#define E_APPCONF_OPT_ACK_MODE 0x0010 //!< ACK付き通信を行う @ingroup FLASH
#define IS_APPCONF_OPT_ACK_MODE() (sAppStg.u32Opt & E_APPCONF_OPT_ACK_MODE) //!< E_APPCONF_OPT_ACK_MODE判定 @ingroup FLASH

#define E_APPCONF_OPT_NO_REGULAR_TX 0x0020 //!< REGULAR 通信しない @ingroup FLASH
#define IS_APPCONF_OPT_NO_REGULAR_TX() (sAppStg.u32Opt & E_APPCONF_OPT_NO_REGULAR_TX) //!< E_APPCONF_OPT_NO_REGULAR_TX判定 @ingroup FLASH

#define E_APPCONF_OPT_ON_PRESS_TRANSMIT 0x0100UL //!< 押し下げ時のみ送信する特殊動作モード。 @ingroup FLASH
#define IS_APPCONF_OPT_ON_PRESS_TRANSMIT() (sAppStg.u32Opt & E_APPCONF_OPT_ON_PRESS_TRANSMIT) //!< E_APPCONF_OPT_ON_PRESS_TRANSMIT判定 @ingroup FLASH

#define E_APPCONF_OPT_NO_C1C2_CONFIG 0x0200 //!< C1/C2ポートによる設定切り替えを無効にする @ingroup FLASH
#define IS_APPCONF_OPT_NO_C1C2_CONFIG() (sAppStg.u32Opt & E_APPCONF_OPT_NO_C1C2_CONFIG) //!< E_APPCONF_OPT_NO_C1C2_CONFIG判定 @ingroup FLASH

#define E_APPCONF_OPT_NO_PULLUP_FOR_INPUT			0x000800UL //!< DI入力にプルアップを適用しない。@ingroup FLASH
#define IS_APPCONF_OPT_NO_PULLUP_FOR_INPUT() (sAppStg.u32Opt & E_APPCONF_OPT_NO_PULLUP_FOR_INPUT) //!< E_APPCONF_OPT_NO_C1C2_CONFIG判定 @ingroup FLASH
...
#define IS_APPCONF_OPT_PORT_TBL1() (sAppStg.u32Opt & E_APPCONF_OPT_PORT_TBL1) //!< E_APPCONF_OPT_PORT_TBL1判定 @ingroup FLASH
#define IS_APPCONF_OPT_PORT_TBL2() (sAppStg.u32Opt & E_APPCONF_OPT_PORT_TBL2) //!< E_APPCONF_OPT_PORT_TBL2判定 @ingroup FLASH

#define E_APPCONF_OPT_CHILD_RECV_OTHER_NODES 0x10000 //!< 子機通常モードで受信を可能とする @ingroup FLASH
#define IS_APPCONF_OPT_CHILD_RECV_OTHER_NODES() (sAppStg.u32Opt & E_APPCONF_OPT_CHILD_RECV_OTHER_NODES) //!< E_APPCONF_OPT_CHILD_RECV_OTHER_NODES判定 @ingroup FLASH

#define E_APPCONF_OPT_CHILD_RECV_NO_IO_DATA 0x20000 //!< IO状態のUART出力を抑制する @ingroup FLASH
#define IS_APPCONF_OPT_CHILD_RECV_NO_IO_DATA() (sAppStg.u32Opt & E_APPCONF_OPT_CHILD_RECV_NO_IO_DATA) //!< E_APPCONF_OPT_CHILD_RECV_NO_IO_DATA判定 @ingroup FLASH

#define E_APPCONF_OPT_WATCHDOG_OUTPUT 0x40000 //!< PORT_EI2 をウォッチドッグ出力とする @ingroup FLASH
#define IS_APPCONF_OPT_WATCHDOG_OUTPUT() (sAppStg.u32Opt & E_APPCONF_OPT_WATCHDOG_OUTPUT) //!< E_APPCONF_OPT_WATCHDOG_OUTPUT判定 @ingroup FLASH

#define E_APPCONF_OPT_DO_INVERT 0x400000UL //!< DIO出力を反転する @ingroup FLASH
#define IS_APPCONF_OPT_DO_INVERT() (sAppStg.u32Opt & E_APPCONF_OPT_DO_INVERT) //!< E_APPCONF_OPT_DO_INVERT判定 @ingroup FLASH

#define E_APPCONF_OPT_DI_INVERT 0x0400UL //!< DIO入力を反転する @ingroup FLASH
#define IS_APPCONF_OPT_DI_INVERT() (sAppStg.u32Opt & E_APPCONF_OPT_DI_INVERT) //!< E_APPCONF_OPT_DI_INVERT判定 @ingroup FLASH

/** サイレントモードの判定マクロ  @ingroup FLASH */
#define IS_APPCONF_ROLE_SILENT_MODE() (sAppStg.u8role == E_APPCONF_ROLE_SILENT)

/** AES 利用のマクロ判定  @ingroup FLASH */
#define IS_CRYPT_MODE() (sAppStg.u8Crypt)
